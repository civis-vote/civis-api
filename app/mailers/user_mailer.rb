		...
		if consultation_responses.last.consultation.public_consultation?
			xlsx.workbook do |workbook|
				workbook.add_worksheet(name: "Consultation Responses") do |sheet|
				  ...
				  response_header = ["Consultation Title", "Consultation Response Text", "Submitted By", "Responder Email", "Satisfication Rating", "Visibility", "Submitted At", "Is Verified", "Source", "Response_Status", "Organisation/Department", "Designation"]
