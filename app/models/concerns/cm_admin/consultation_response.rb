    ...
    included do
      cm_admin do
        ...
        cm_index do
          ...
          filter :theme, :multi_select, helper_method: :select_options_for_theme, filter_with: :theme_filter, active_by_default: true
          filter :department, :multi_select, helper_method: :select_options_for_department,
                                                    filter_with: :department_filter, active_by_default: true
